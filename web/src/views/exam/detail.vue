      ...
      <el-col :span="2" class="seaTex">
        <el-input
          ...
          >
            ...
            <el-col :span="2"  class="seaButton">
              <el-button type="primary" v-on:click="search" >查找</el-button>
            </el-col>
    </el-row>
    <el-row >
      <el-col :span="2"
  ...
  methods: {
    search:function(event){
      ...
      let promise = new Promise(function(resolve, reject){
        _this.$http.get('http://localhost:8080/selectStunamebyid.action?id='+id).then(
        function (res) {
          if(res.bodyText=='')
            alert("请输入正确的学号")
          else{
               _this.stuname=res.bodyText;
                _this.$http.get('http://localhost:8080/selectteacherbystupro.action?id='+id).then(
                function (res) {
            ...
            this.$http.get('http://localhost:8080/selectgradebyid.action?id='+id+'&project='+item).then(
              function (res) {
      ...
      promise.then(()=>console.log(222222222))
